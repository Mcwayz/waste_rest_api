...
function floatchart() {
  ...
  (function () {
    ...
    var chart = new ApexCharts(document.querySelector('#new-orders-graph'), options);
    chart.render();
  })();
  (function () {
    var options = {
    ...
    var chart = new ApexCharts(document.querySelector('#new-users-graph'), options);
    chart.render();
  })();
  (function () {
    var options = {
    ...
    var chart = new ApexCharts(document.querySelector('#visitors-graph'), options);
    chart.render();
  })();
  ...
  (function () {
    ...
    var chart1 = new ApexCharts(document.querySelector('#overview-chart-3'), options);
    chart1.render();
  })();
  (function () {
    var options = {
    ...
    chart.render();
    var chart1 = new ApexCharts(document.querySelector('#overview-chart-4'), options);
    chart1.render();
  })();
  ...
  (function () {
    ...
    var chart = new ApexCharts(document.querySelector('#languages-graph'), options);
    chart.render();
  })();
  ...
  (function () {
    ...
    var chart = new ApexCharts(document.querySelector('#overview-product-graph'), options);
    chart.render();
  })();
